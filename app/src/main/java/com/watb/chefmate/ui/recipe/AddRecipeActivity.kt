...
fun AddRecipeScreen(
    ...
    var nameRecipe = remember { mutableStateOf("") }
    var cookTime = remember { mutableStateOf("") }
    var ration = remember { mutableStateOf("") }
    ...
    ConstraintLayout(
        ...
        Row(
            ...
            IconButton(
                onClick = {
                    navController.popBackStack() // Quay trở lại màn hình trước
                }
            ) {
                Icon(
        ...
        Column( // Đổi sang Column để dễ dàng cuộn
            modifier = Modifier
                .background(
                    Color(0xFFFFFFFF),
                ...
                .verticalScroll(scrollState) // Thêm cuộn dọc
                .padding(horizontal = 20.dp, vertical = 12.dp) // Thêm padding chung
        ) {
            // Image Picker
            if (selectedImageBitmap != null) {
                ...
                Image(
                    painter = painterResource(R.drawable.placeholder_image), // Thay thế bằng một placeholder phù hợp hơn
                    contentDescription = "Chọn ảnh công thức",
                    contentScale = ContentScale.Crop,
                    modifier = Modifier
                        .fillMaxWidth(0.9f)
                        .height(180.dp)
            ...
            Column(
                ...
                ingredientsList.forEachIndexed { index, ingredient ->
                    Row(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = { newValue ->
                                if (newValue.all { it.isDigit() } || newValue.isEmpty()) {
                                    ingredientsList[index] = ingredient.copy(weight = newValue)
                                }
                            },
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = { ingredientsList[index] = ingredient.copy(unit = it) },
                        ...
                        if (ingredientsList.size > 1) { // Chỉ hiển thị nút xóa nếu có hơn 1 trường
                ...
                Row(
                    verticalAlignment = Alignment.CenterVertically,
                    modifier = Modifier.clickable { ingredientsList.add(IngredientInput("", "", "")) }
                ) {
                    Icon(
                ...
                stepsList.forEachIndexed { index, step ->
                    Row(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = { stepsList[index] = step.copy(content = it) },
...
//                            value = step.content,
//                            onValueChange = { stepsList[index] = step.copy(content = it) },
//                            label = { Text(text = "Thực hiện", fontSize = 12.sp) },
//                            colors = OutlinedTextFieldDefaults.colors(
//                                focusedBorderColor = Color(0xFFE0E0E0),
//                                unfocusedBorderColor = Color(0xFFE0E0E0)
//                            ),
...
//                        )
                        if (stepsList.size > 1) { // Chỉ hiển thị nút xóa nếu có hơn 1 trường
                ...
                Row(
                    verticalAlignment = Alignment.CenterVertically,
                    modifier = Modifier.clickable { stepsList.add(StepInput(stepsList.size + 1, "")) }
                ) {
                    Icon(
                        painterResource(R.drawable.ic_add),
            ...
            Button(
                onClick = {
                    scope.launch {
                        ...
                        val ingredientsToSave: List<Pair<String, Pair<Int, String>>> = ingredientsList.map {
                            Pair(it.name, Pair(it.weight.toIntOrNull() ?: 0, it.unit))
                        }
                        val stepsToSave = stepsList.map {
                            it.index to it.content
                        }
                        ...
                        if (recipeId == 0) {
                            ...
                            selectedImageBitmap?.let {
                                viewModel.addRecipe(
                                    ...
                                    imageUri = selectedImageBitmap!!,
                                    userId = 1, // Thay bằng userId thực tế
                                    isPublic = isPublic,
                                    likeQuantity = 0,
